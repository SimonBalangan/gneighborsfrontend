                ...
                <div className='card-wrapper'>
                    ...
                    <div className='card'>
                        <div className='image-content'>
                                ...
                                <div className='card-image'>
                                    <img className='card-img' src="https://www.peerby.com/beta-dashboard/img/ill_how-dem-1.png" alt='Bild 1'/>
                                </div>
                    ...
                    <div className='card'>
                        <div className='image-content'>
                                ...
                                <div className='card-image'>
                                    <img className='card-img' src="https://www.peerby.com/beta-dashboard/img/ill_how-dem-2.png" alt='Bild 1'/>
                                </div>
                        <div className='card-content'>
                    ...
                    <div className='card'>
                        <div className='image-content'>
                                ...
                                <div className='card-image'>
                                    <img className='card-img' src="https://www.peerby.com/beta-dashboard/img/ill_how-dem-3.png" alt='Bild 1'/>
                                </div>
                        <div className='card-content'>
                    ...
                    <div className='card'>
                        <div className='image-content'>
                                ...
                                <div className='card-image'>
                                    <img className='card-img' src="https://www.peerby.com/beta-dashboard/img/ill_how-dem-4.png" alt='Bild 1'/>
                                </div>
                        <div className='card-content'>
        ...
        <div className='slide-content'>
            <div className='card-wrapper'>
                <div className='card'>
                    ...
                    <div className='card-content'>
                        <h2 className='name'>Simon Bolenz</h2>
                        <p className='description'> Balblablkdhakdhaldhaslkdsakdsölakdnlöksadasahajk
                        ahsalhsalkshalkSHAlkshaklsHAlshalkS</p>
